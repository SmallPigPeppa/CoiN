...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
    ...
    --previous_task_model_path ./checkpoints/LLaVA/Instruction/CoIN_rank192/Grounding_llava_lora \
    ...
    --bf16 True \
    --output_dir ./checkpoints/LLaVA/Instruction/CoIN_rank192/VQAv2_llava_lora \
    --num_train_epochs 1 \
